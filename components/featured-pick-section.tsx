      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-8 pb-6 border-b border-border">
          <div>
            ...
            <h2 className="font-heading font-extrabold text-3xl md:text-4xl text-foreground leading-tight uppercase tracking-tight">
          ...
          <p className="text-muted-foreground text-sm leading-relaxed max-w-xs font-sans">
            Our highest-rated UK sportsbook this month, verified by live testing.
          </p>
        </div>

        {/* Horizontal featured card */}
        <div
          className="relative overflow-hidden rounded-sm border border-primary/40 bg-card rank-1-glow"
        ...
        >
          ...
          <div className="flex flex-col md:flex-row md:items-stretch">
            ...
            <div className="flex flex-col items-center justify-center gap-4 p-8 md:p-10 md:w-72 md:border-r md:border-border bg-surface/50">
              <span className="inline-flex items-center gap-1.5 text-[10px] font-heading font-bold uppercase tracking-[0.12em] text-primary bg-primary/10 border border-primary/25 px-3 py-1 rounded-sm">
                #1 Elite Pick — {new Date().toLocaleString("en-GB", { month: "long", year: "numeric" })}
              </span>
