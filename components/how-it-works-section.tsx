      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="mb-8 pb-6 border-b border-border">
          <div className="flex items-center gap-3 mb-3">
            ...
            <p className="font-heading font-bold text-[11px] uppercase tracking-[0.18em] text-primary">
              Our Methodology
            </p>
          </div>
          <h2
            id="vip-methodology-heading"
            className="font-heading font-extrabold text-3xl md:text-4xl text-foreground leading-tight uppercase tracking-tight"
          >
            How British Elite Betting Sites Works
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4" role="list">
          {methodologySteps.map(({ number, title, body }) => (
            <div
              key={number}
              className="bg-card border border-border rounded-sm p-6 flex flex-col gap-4 card-hover"
              role="listitem"
            >
        ...
        >
          <div className="flex-1">
            ...
            <p className="text-xs text-muted-foreground leading-relaxed font-sans">
              British Elite Betting Sites may earn affiliate revenue when you visit an operator through our links. This commercial arrangement has no bearing on our editorial rankings or expert scoring — assessments are determined solely by our methodology criteria.
            </p>
          </div>
          <div className="flex-shrink-0 text-[11px] font-heading font-semibold uppercase tracking-widest text-primary border border-primary/30 rounded-sm px-3 py-2 bg-card whitespace-nowrap">
